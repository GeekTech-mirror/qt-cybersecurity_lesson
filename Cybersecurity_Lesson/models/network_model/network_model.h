...
public:
    ...
    /* Network Properties */
    void setWirelessProperties (const WirelessProperties &wifi_prop, const bool isEnabled);
...
private:
    ...
    void removeWirelessNetwork(int row);

    void update_network_list (const NetworkManager::WirelessNetwork::Ptr &network,
